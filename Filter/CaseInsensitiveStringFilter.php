...
namespace Umanit\SonataAdminPostgreSQLSearchBundle\Filter;
...
/**
 * Case insensitive and unaccented based on search(https://gist.github.com/dbu/9524776).
 */
    ...
    public function filter(ProxyQueryInterface $queryBuilder, $alias, $field, $data)
    {
        ...
        if ($data['type'] == ChoiceType::TYPE_EQUAL) {
            ...
            $queryBuilder->setParameter($parameterName, sprintf(
                ...
                $this->handleParameter($data['value'])
            ));
        }
    }
